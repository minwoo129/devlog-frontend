...
![](https://velog.velcdn.com/images/minwoo129/post/1cd5f1bc-3261-4a5e-84f5-2f66945b9a2a/image.jpg)
...
![](https://velog.velcdn.com/images/minwoo129/post/06df3a60-e76d-40ca-a90e-6302ed415fb8/image.webp)
...
![](https://velog.velcdn.com/images/minwoo129/post/b551ef9e-e682-4c0d-9b9f-7809ae5b5b06/image.png)
...
## 4-2. 그 외 업데이트 사항
### <span style={{color: "#22c55e"}}>Aggregations(집계 기능)</span>
모든 개별 문서를 읽을 필요 없이 문서의 개수를 세거나 필드값의 합계 또는 평균을 얻을 수 있도록 업데이트 되었습니다
### <span style={{color: "#22c55e"}}>쿼리 내 OR 조건 사용 가능</span>
### <span style={{color: "#22c55e"}}>단일 쿼리의 여러 필드에 대한 범위 조건 사용 가능</span>
### <span style={{color: "#22c55e"}}>한 프로젝트 내에서 여러개의 데이터베이스 추가 가능</span>
### <span style={{color: "#22c55e"}}>Point-in-time 복구 기능</span>
코딩 실수 또는 사용자의 오류로 부터 데이터를 보호할 수 있는 기능
### <span style={{color: "#22c55e"}}>Scheduled Backups</span>
설정한 주기에 따라 자동으로 전체 데이터베이스가 백업되는 기능

# 5. Firebase Data Connect(비공개 미리보기)
![](https://velog.velcdn.com/images/minwoo129/post/0d3c1246-21e3-4df5-b777-bcd78081fef2/image.png)
...
![](https://velog.velcdn.com/images/minwoo129/post/961210e0-253c-47b6-bf8f-77f2ca737ad1/image.png)
...
![](https://velog.velcdn.com/images/minwoo129/post/0480d11a-e47b-4f92-9d12-5a9c5a4e0ba3/image.jpg)
...
![](https://velog.velcdn.com/images/minwoo129/post/4c4d9630-aea8-4743-a764-d81ebbd4ce14/image.png)
...
![](https://velog.velcdn.com/images/minwoo129/post/f352c956-37c0-4c1e-9a69-778db3e2fe5f/image.png)
그리고 "AI 인사이트 생성" 버튼을 클릭하면 아래와 같이 간단한 솔루션을 제공하는 Gemini 분석 결과를 제공합니다.
![](https://velog.velcdn.com/images/minwoo129/post/d40ac38e-3588-4b56-84ff-da33cebccde6/image.png)
...
![](https://velog.velcdn.com/images/minwoo129/post/ad8e2f1e-d667-4fe6-ae75-7924822b6695/image.jpg)
...
# 강의 링크(Youtube)
[![](https://velog.velcdn.com/images/minwoo129/post/7f17810a-1522-4709-aa30-a0e8025b7fc1/image.jpg)](https://youtu.be/2MvV-YX1eKw?si=2vNPB_c8AlkLa2IL)
